(function(){
  ...
  const DIAG_CHARS={アガル:['熱量拡散型','場の温度を一段上げる人。外向性と新奇探索が高く、体験の入り口で迷う人の背中を押せる。','続きの物語：アガルは街の小さな火花を集め、退屈な午後を祭りに変える。'],ツムギ:['審美編集型','雰囲気、意味、手触りをつなぐ人。好き嫌いの解像度が高く、場所の良さを言語化できる。','続きの物語：ツムギは古い布の記憶から、その人だけの今日の服を編む。'],ヌクミ:['安心共感型','安全基地を作れる人。共感性と回復志向が強く、誰かがほっとできる選択を見つける。','続きの物語：ヌクミのいる席では、急がなくていい時間だけが流れる。'],テクル:['探究実装型','仕組みを見抜き、試して形にする人。学習欲と計画性が高く、体験を自分のスキルに変える。','続きの物語：テクルは街の裏側にある装置を直し、明日の扉を開ける。'],コネル:['没頭創造型','深く潜って独自の世界を作る人。内省と創造性が高く、流行の奥にある美しさを見つける。','続きの物語：コネルの机から生まれた小さな案は、やがて街の合言葉になる。'],フワリ:['観察余白型','静かに見て、本質を拾う人。刺激より余白を大事にし、自分のペースで深く楽しめる。','続きの物語：フワリは風の向きだけで、その日いちばん優しい道を知っている。'],ネクスケ:['発見案内型','好奇心と安全感のバランスが良い案内役。人、場所、予定をつなぐのが得意。','続きの物語：ネクスケは地図にない印を見つけ、今日を少しだけ特別にする。'],カゲ:['静かな突破型','少人数や裏側で力を発揮する人。派手さより確かな行動で、体験を深く記憶に残す。','続きの物語：カゲは夜道の危ない角を避け、光のある場所へ仲間を導く。']};
